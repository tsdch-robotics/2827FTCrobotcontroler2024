...
public class BlueRightTwoSpecimins extends LinearOpMode {
    ...
    Action preScore = new Action(new Position2d(5, -37, Math.toRadians(0)), 2, targetVerticalIdea.PRE_SCORE_SPECIMEN, targetHorizontalIdea.READY_HS_POS);
    Action score = new Action(new Position2d(5, -37, Math.toRadians(0)), 2, targetVerticalIdea.SCORE_SPECIMEN, targetHorizontalIdea.READY_HS_POS);//prevoulsy extend
    Action drop = new Action(new Position2d(5, -38, Math.toRadians(0)), 2, targetVerticalIdea.RELEASE, targetHorizontalIdea.READY_HS_POS);//prevoulsy extend

    Action prepareToCollect = new Action(new Position2d(36, -55, Math.toRadians(0)), 3, targetVerticalIdea.COLLECT_SPECIMIN_AUTO, targetHorizontalIdea.READY_HS_POS);

    Action collect = new Action(new Position2d(36, -63, Math.toRadians(0)), 3, targetVerticalIdea.COLLECT_SPECIMIN_AUTO, targetHorizontalIdea.READY_HS_POS);
    Action grab = new Action(new Position2d(36, -63, Math.toRadians(0)), 3, targetVerticalIdea.SQUEEZE_THE_CATCH, targetHorizontalIdea.READY_HS_POS);

    Action safeRaise = new Action(new Position2d(36, -63, Math.toRadians(0)), 3, targetVerticalIdea.SAFE_RAISE, targetHorizontalIdea.READY_HS_POS);


    Action act2 = new Action(new Position2d(1,-50,Math.toRadians(0)), 2, targetVerticalIdea.ZERO_VS_SLIDES, targetHorizontalIdea.ZERO_HS_SLIDES);


    //act1, prescore, score, drop, park

    Action park = new Action(new Position2d(45, -60, Math.toRadians(0)), 3, targetVerticalIdea.PARK, targetHorizontalIdea.READY_HS_POS);
