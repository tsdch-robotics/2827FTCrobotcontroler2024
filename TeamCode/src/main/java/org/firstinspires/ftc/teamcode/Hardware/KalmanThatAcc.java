...
@Config
public class KalmanThatAcc {
    //lower covarience - greater confidence in the source
    public static double Q = 0.001;  // Process noise covariance (adjustable)//lower val means less acurate system on its own, more trust in formula
    ...
    public KalmanThatAcc(double initialValue) {
        this.X = initialValue;
    }
